...
struct FlutterBiometricKycJobResult: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> FlutterBiometricKycJobResult? {
    ...
    let dob: String? = nilOrValue(pigeonVar_list[6])
    let photoBase64: String? = nilOrValue(pigeonVar_list[7])
    let gender: String? = nilOrValue(pigeonVar_list[8])
    let idType: String? = nilOrValue(pigeonVar_list[9])
    let address: String? = nilOrValue(pigeonVar_list[10])
    let country: String? = nilOrValue(pigeonVar_list[11])
    let documentImageBase64: String? = nilOrValue(pigeonVar_list[12])
    let fullData: [String?: String?]? = nilOrValue(pigeonVar_list[13])
    let fullName: String? = nilOrValue(pigeonVar_list[14])
    let idNumber: String? = nilOrValue(pigeonVar_list[15])
    let phoneNumber: String? = nilOrValue(pigeonVar_list[16])
    let phoneNumber2: String? = nilOrValue(pigeonVar_list[17])
    let expirationDate: String? = nilOrValue(pigeonVar_list[18])
    let secondaryIdNumber: String? = nilOrValue(pigeonVar_list[19])
    let idNumberPreviouslyRegistered: Bool? = nilOrValue(pigeonVar_list[20])
    let previousRegistrantsUserIds: [String?]? = nilOrValue(pigeonVar_list[21])
