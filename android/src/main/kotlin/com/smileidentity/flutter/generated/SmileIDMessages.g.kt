...
private object SmileIDMessagesPigeonUtils {
  ...
  fun createConnectionError(channelName: String): SmileFlutterError {
...
data class FlutterSuspectUser (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    if (other !is FlutterSuspectUser) {
      return false
    }
    if (this === other) {
      return true
...
data class DocumentCaptureResult (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    if (other !is DocumentCaptureResult) {
      return false
    }
    if (this === other) {
      return true
...
class SmileIDProductsResultApi(private val binaryMessenger: BinaryMessenger, private val messageChannelSuffix: String = "") {
  ...
  fun onDocumentVerificationResult(successResultArg: DocumentCaptureResult?, errorResultArg: String?, callback: (Result<Unit>) -> Unit)
{
    val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    val channelName = "dev.flutter.pigeon.smileid.SmileIDProductsResultApi.onDocumentVerificationResult$separatedMessageChannelSuffix"
    ...
    channel.send(listOf(successResultArg, errorResultArg)) {
      if (it is List<*>) {
        ...
        callback(Result.failure(SmileIDMessagesPigeonUtils.createConnectionError(channelName)))
      } 
    }
  }
  fun onDocumentVerificationEnhancedResult(successResultArg: DocumentCaptureResult?, errorResultArg: String?, callback: (Result<Unit>) -> Unit)
{
    val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    val channelName = "dev.flutter.pigeon.smileid.SmileIDProductsResultApi.onDocumentVerificationEnhancedResult$separatedMessageChannelSuffix"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(successResultArg, errorResultArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
  ...
  fun onSmartSelfieEnrollmentResult(successResultArg: SmartSelfieCaptureResult?, errorResultArg: String?, callback: (Result<Unit>) -> Unit)
{
  ...
  fun onSmartSelfieAuthenticationResult(successResultArg: SmartSelfieCaptureResult?, errorResultArg: String?, callback: (Result<Unit>) -> Unit)
{
    val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    val channelName = "dev.flutter.pigeon.smileid.SmileIDProductsResultApi.onSmartSelfieAuthenticationResult$separatedMessageChannelSuffix"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(successResultArg, errorResultArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
  ...
  fun onSmartSelfieEnrollmentEnhancedResult(successResultArg: SmartSelfieCaptureResult?, errorResultArg: String?, callback: (Result<Unit>) -> Unit)
{
    val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    val channelName = "dev.flutter.pigeon.smileid.SmileIDProductsResultApi.onSmartSelfieEnrollmentEnhancedResult$separatedMessageChannelSuffix"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(successResultArg, errorResultArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
  ...
  fun onSmartSelfieAuthenticationEnhancedResult(successResultArg: SmartSelfieCaptureResult?, errorResultArg: String?, callback: (Result<Unit>) -> Unit)
{
    val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    val channelName = "dev.flutter.pigeon.smileid.SmileIDProductsResultApi.onSmartSelfieAuthenticationEnhancedResult$separatedMessageChannelSuffix"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(successResultArg, errorResultArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
  ...
  fun onBiometricKYCResult(successResultArg: BiometricKYCCaptureResult?, errorResultArg: String?, callback: (Result<Unit>) -> Unit)
{
    val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    val channelName = "dev.flutter.pigeon.smileid.SmileIDProductsResultApi.onBiometricKYCResult$separatedMessageChannelSuffix"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(successResultArg, errorResultArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
  ...
  fun onSelfieCaptureResult(successResultArg: SmartSelfieCaptureResult?, errorResultArg: String?, callback: (Result<Unit>) -> Unit)
{
    val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    val channelName = "dev.flutter.pigeon.smileid.SmileIDProductsResultApi.onSelfieCaptureResult$separatedMessageChannelSuffix"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(successResultArg, errorResultArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
  ...
  fun onDocumentCaptureResult(successResultArg: DocumentCaptureResult?, errorResultArg: String?, callback: (Result<Unit>) -> Unit)
{
    val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    val channelName = "dev.flutter.pigeon.smileid.SmileIDProductsResultApi.onDocumentCaptureResult$separatedMessageChannelSuffix"
    val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
    channel.send(listOf(successResultArg, errorResultArg)) {
      if (it is List<*>) {
        if (it.size > 1) {
