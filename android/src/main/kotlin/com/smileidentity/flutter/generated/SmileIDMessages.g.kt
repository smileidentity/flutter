...
interface SmileIDApi {
  ...
  fun initialize(useSandbox: Boolean, enableCrashReporting: Boolean)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val enableCrashReportingArg = args[1] as Boolean
            val wrapped: List<Any?> = try {
              api.initialize(useSandboxArg, enableCrashReportingArg)
              listOf(null)
            } catch (exception: Throwable) {
              SmileIDMessagesPigeonUtils.wrapError(exception)
            }
