...
private fun wrapError(exception: Throwable): List<Any?> = if (exception is SmileFlutterError) {
    listOf(
        exception.code,
        exception.message,
        exception.details,
...
private fun createConnectionError(channelName: String): SmileFlutterError = SmileFlutterError(
    "channel-error",
        ...
        fun setUp(
            ...
            run {
                val channel =
                    BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.smileid.SmileIDProductsApi.documentVerification$separatedMessageChannelSuffix",
                        codec,
                    )
                if (api != null) {
                    channel.setMessageHandler { message, reply ->
                        ...
                        api.documentVerification(
                            creationParamsArg,
                        ) { result: Result<DocumentCaptureResult> ->
            ...
            run {
                val channel =
                    BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.smileid.SmileIDProductsApi.documentVerificationEnhanced$separatedMessageChannelSuffix",
                        codec,
                    )
                if (api != null) {
                    channel.setMessageHandler { message, reply ->
                        ...
                        api.documentVerificationEnhanced(
                            creationParamsArg,
                        ) { result: Result<DocumentCaptureResult> ->
                            val error = result.exceptionOrNull()
                            if (error != null) {
            ...
            run {
                val channel =
                    BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.smileid.SmileIDProductsApi.biometricKYC$separatedMessageChannelSuffix",
                        codec,
                    )
                if (api != null) {
                    channel.setMessageHandler { message, reply ->
                        ...
                        api.biometricKYC(
                            creationParamsArg,
                        ) { result: Result<BiometricKYCCaptureResult> ->
                            val error = result.exceptionOrNull()
                            if (error != null) {
                                reply.reply(wrapError(error))
                            } else {
            ...
            run {
                val channel =
                    BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.smileid.SmileIDProductsApi.selfieCapture$separatedMessageChannelSuffix",
                        codec,
                    )
                if (api != null) {
                    channel.setMessageHandler { message, reply ->
            ...
            run {
                val channel =
                    BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.smileid.SmileIDProductsApi.documentCapture$separatedMessageChannelSuffix",
                        codec,
                    )
                if (api != null) {
                    channel.setMessageHandler { message, reply ->
...
class SmileIDProductsResultApi(
    ...
    fun onDocumentVerificationResult(
        successResultArg: DocumentCaptureResult?,
        errorResultArg: String?,
        ...
        channel.send(listOf(successResultArg, errorResultArg)) {
            if (it is List<*>) {
                if (it.size > 1) {
                    callback(
                        Result.failure(
                            SmileFlutterError(it[0] as String, it[1] as String, it[2] as String?),
                        ),
                    )
                } else {
    ...
    fun onDocumentVerificationEnhancedResult(
        successResultArg: DocumentCaptureResult?,
        errorResultArg: String?,
        callback: (Result<Unit>) -> Unit,
    ) {
    ...
    fun onSmartSelfieEnrollmentResult(
        successResultArg: SmartSelfieCaptureResult?,
        errorResultArg: String?,
        callback: (Result<Unit>) -> Unit,
    ) {
        val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    ...
    fun onSmartSelfieEnrollmentEnhancedResult(
        successResultArg: SmartSelfieCaptureResult?,
        errorResultArg: String?,
        callback: (Result<Unit>) -> Unit,
    ) {
    ...
    fun onSmartSelfieAuthenticationEnhancedResult(
        successResultArg: SmartSelfieCaptureResult?,
        errorResultArg: String?,
        callback: (Result<Unit>) -> Unit,
    ) {
    ...
    fun onBiometricKYCResult(
        successResultArg: BiometricKYCCaptureResult?,
        errorResultArg: String?,
        callback: (Result<Unit>) -> Unit,
    ) {
        val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
